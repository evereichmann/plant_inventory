...
class PlantsTest < ApplicationSystemTestCase
  ...
  test "creating a Plant" do
    ...
    fill_in "Arrival date", with: @plant.arrival_date
    fill_in "Condition", with: @plant.condition
    fill_in "Name", with: @plant.name
    fill_in "Order", with: @plant.order_id
    fill_in "Price", with: @plant.price
    fill_in "Recovery date", with: @plant.recovery_date
    check "Sold" if @plant.sold
    fill_in "Unit price", with: @plant.unit_price
